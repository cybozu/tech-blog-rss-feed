...
type FeedInfoTuple = [label: string, url: ValidUrl, mediatype: string];
 ...
 * ブログリストでブログと音声コンテンツを分けて表示するために、メディアタイプ（blog, podcast のみ）を設定してください
 */
// prettier-ignore
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  // ['企業名・製品名など', 'RSS/AtomフィードのURL', 'メディアタイプ（blog, podcast)],
